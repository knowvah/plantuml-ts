...
import { buildDotPathFromSplinePoints, edgeMidpoint } from '../../../../src/core/svek/svek-edge-geometry.js';
...
function rawPoints(frag: string, decor: LinkDecorName, side: 'head' | 'tail'): Point2D[] {
  ...
  if (side === 'head') {
    ...
    return [p0, p1, { x: p2.x + len * u.x, y: p2.y + len * u.y }, { x: p3.x + len * u.x, y: p3.y + len * u.y }];
  }
  const u = unitToward(p0, p1);
  return [{ x: p0.x + len * u.x, y: p0.y + len * u.y }, { x: p1.x + len * u.x, y: p1.y + len * u.y }, p2, p3];
}
...
const GOLDENS: Record<string, DecorGolden> = {
  EXTENDS: {
    ...
    token: '|>',
    puml: '--|>',
    frag: '<!--link a to b--><g class="link" data-entity-1="ent0001" data-entity-2="ent0002" id="lnk3" data-source-line="4" data-link-type="extension"><path d="M22,43.58 C22,60.52 22,68.18 22,85.2" style="stroke:#181818;stroke-width:1;" fill="none" id="a-to-b"/><polygon points="22,103.2,28,85.2,16,85.2,22,103.2" fill="none" style="stroke:#181818;stroke-width:1;stroke-linejoin:miter;stroke-miterlimit:10;"/></g>',
  },
  EXTENDS_caret: {
    decor: 'EXTENDS',
    side: 'head',
  ...
  COMPOSITION: {
    ...
    token: '*',
    puml: '--*',
    frag: '<!--link a to b--><g class="link" data-entity-1="ent0001" data-entity-2="ent0002" id="lnk3" data-source-line="4" data-link-type="composition"><path d="M21.41,43.58 C21.41,60.52 21.41,74.18 21.41,91.2" style="stroke:#181818;stroke-width:1;" fill="none" id="a-to-b"/><polygon points="21.41,103.2,25.41,97.2,21.41,91.2,17.41,97.2,21.41,103.2" fill="#181818" style="stroke:#181818;stroke-width:1;stroke-linejoin:miter;stroke-miterlimit:10;"/></g>',
  },
  AGGREGATION: {
    decor: 'AGGREGATION',
    side: 'head',
    token: 'o',
    puml: '--o',
    frag: '<!--link a to b--><g class="link" data-entity-1="ent0001" data-entity-2="ent0002" id="lnk3" data-source-line="4" data-link-type="aggregation"><path d="M21.41,43.58 C21.41,60.52 21.41,74.18 21.41,91.2" style="stroke:#181818;stroke-width:1;" fill="none" id="a-to-b"/><polygon points="21.41,103.2,25.41,97.2,21.41,91.2,17.41,97.2,21.41,103.2" fill="none" style="stroke:#181818;stroke-width:1;stroke-linejoin:miter;stroke-miterlimit:10;"/></g>',
  },
  NOT_NAVIGABLE: {
    decor: 'NOT_NAVIGABLE',
    side: 'head',
    token: 'x',
    puml: '--x',
    frag: '<!--link a to b--><g class="link" data-entity-1="ent0001" data-entity-2="ent0002" id="lnk3" data-source-line="4" data-link-type="not_navigable"><path d="M21.41,43.58 C21.41,60.52 21.41,78.18 21.41,95.2" style="stroke:#181818;stroke-width:1;" fill="none" id="a-to-b"/><path d="M25.41,98.2 L17.41,90.2 M17.41,98.2 L25.41,90.2" style="stroke:#181818;stroke-width:1;" fill="none"/></g>',
  },
  REDEFINES: {
    decor: 'REDEFINES',
    side: 'head',
    token: '||>',
    puml: '--||>',
    frag: '<!--link a to b--><g class="link" data-entity-1="ent0001" data-entity-2="ent0002" id="lnk3" data-source-line="4" data-link-type="redefines"><path d="M23,43.58 C23,60.52 23,68.18 23,85.2" style="stroke:#181818;stroke-width:1;" fill="none" id="a-to-b"/><polygon points="23,103.2,16,84.2,30,84.2,23,103.2" fill="#FFF" style="stroke:#181818;stroke-width:1;stroke-linejoin:miter;stroke-miterlimit:10;"/><line x1="16" y1="80.4" x2="30" y2="80.4" style="stroke:#181818;stroke-width:2;"/></g>',
  },
  DEFINEDBY: {
    decor: 'DEFINEDBY',
    side: 'head',
    token: ':|>',
    puml: '--:|>',
    frag: '<!--link a to b--><g class="link" data-entity-1="ent0001" data-entity-2="ent0002" id="lnk3" data-source-line="4" data-link-type="definedby"><path d="M23,43.58 C23,60.52 23,68.18 23,85.2" style="stroke:#181818;stroke-width:1;" fill="none" id="a-to-b"/><polygon points="23,103.2,16,84.2,30,84.2,23,103.2" fill="#FFF" style="stroke:#181818;stroke-width:1;stroke-linejoin:miter;stroke-miterlimit:10;"/><ellipse cx="18" cy="78.5" rx="2" ry="2" fill="#181818" style="stroke:#181818;stroke-width:1;"/><ellipse cx="28" cy="78.5" rx="2" ry="2" fill="#181818" style="stroke:#181818;stroke-width:1;"/></g>',
  },
  CROWFOOT: {
    decor: 'CROWFOOT',
    side: 'head',
    token: '{',
    puml: '--{',
    frag: '<!--link a to b--><g class="link" data-entity-1="ent0001" data-entity-2="ent0002" id="lnk3" data-source-line="4" data-link-type="crowfoot"><path d="M21.41,43.58 C21.41,60.52 21.41,78.18 21.41,95.2" style="stroke:#181818;stroke-width:1;" fill="none" id="a-to-b"/><line x1="21.41" y1="95.2" x2="29.41" y2="103.2" style="stroke:#181818;stroke-width:1;"/><line x1="21.41" y1="95.2" x2="13.41" y2="103.2" style="stroke:#181818;stroke-width:1;"/><line x1="21.41" y1="95.2" x2="21.41" y2="103.2" style="stroke:#181818;stroke-width:1;"/></g>',
  },
  CIRCLE_CROWFOOT: {
    decor: 'CIRCLE_CROWFOOT',
    side: 'head',
    token: 'o{',
    puml: '--o{',
    frag: '<!--link a to b--><g class="link" data-entity-1="ent0001" data-entity-2="ent0002" id="lnk3" data-source-line="4" data-link-type="crowfoot"><path d="M21.41,43.58 C21.41,60.52 21.41,68.18 21.41,85.2" style="stroke:#181818;stroke-width:1;" fill="none" id="a-to-b"/><line x1="21.41" y1="95.2" x2="27.41" y2="103.2" style="stroke:#181818;stroke-width:1;"/><line x1="21.41" y1="95.2" x2="15.41" y2="103.2" style="stroke:#181818;stroke-width:1;"/><line x1="21.41" y1="95.2" x2="21.41" y2="103.2" style="stroke:#181818;stroke-width:1;"/><ellipse cx="21.41" cy="89.2" rx="4" ry="4" fill="none" style="stroke:#181818;stroke-width:1;"/></g>',
  },
  CIRCLE_LINE: {
    decor: 'CIRCLE_LINE',
    side: 'head',
    token: 'o|',
    puml: '--o|',
    frag: '<!--link a to b--><g class="link" data-entity-1="ent0001" data-entity-2="ent0002" id="lnk3" data-source-line="4" data-link-type="association"><path d="M21.41,43.58 C21.41,60.52 21.41,71.18 21.41,88.2" style="stroke:#181818;stroke-width:1;" fill="none" id="a-to-b"/><line x1="21.41" y1="92.2" x2="21.41" y2="103.2" style="stroke:#181818;stroke-width:1;"/><ellipse cx="21.41" cy="92.2" rx="4" ry="4" fill="none" style="stroke:#181818;stroke-width:1;"/><line x1="25.41" y1="99.2" x2="17.41" y2="99.2" style="stroke:#181818;stroke-width:1;"/></g>',
  },
  DOUBLE_LINE: {
    decor: 'DOUBLE_LINE',
    side: 'head',
    token: '||',
    puml: '--||',
    frag: '<!--link a to b--><g class="link" data-entity-1="ent0001" data-entity-2="ent0002" id="lnk3" data-source-line="4" data-link-type="association"><path d="M21.41,43.58 C21.41,60.52 21.41,78.18 21.41,95.2" style="stroke:#181818;stroke-width:1;" fill="none" id="a-to-b"/><line x1="25.41" y1="99.2" x2="17.41" y2="99.2" style="stroke:#181818;stroke-width:1;"/><line x1="25.41" y1="96.2" x2="17.41" y2="96.2" style="stroke:#181818;stroke-width:1;"/><line x1="21.41" y1="95.2" x2="21.41" y2="103.2" style="stroke:#181818;stroke-width:1;"/></g>',
  },
  LINE_CROWFOOT: {
    decor: 'LINE_CROWFOOT',
    side: 'head',
    token: '|{',
    puml: '--|{',
    frag: '<!--link a to b--><g class="link" data-entity-1="ent0001" data-entity-2="ent0002" id="lnk3" data-source-line="4" data-link-type="crowfoot"><path d="M21.41,43.58 C21.41,60.52 21.41,78.18 21.41,95.2" style="stroke:#181818;stroke-width:1;" fill="none" id="a-to-b"/><line x1="21.41" y1="95.2" x2="27.41" y2="103.2" style="stroke:#181818;stroke-width:1;"/><line x1="21.41" y1="95.2" x2="15.41" y2="103.2" style="stroke:#181818;stroke-width:1;"/><line x1="21.41" y1="95.2" x2="21.41" y2="103.2" style="stroke:#181818;stroke-width:1;"/><line x1="25.41" y1="93.2" x2="17.41" y2="93.2" style="stroke:#181818;stroke-width:1;"/></g>',
  },
  ARROW: {
    decor: 'ARROW',
    side: 'head',
    token: '>',
    puml: '-->',
    frag: '<!--link a to b--><g class="link" data-entity-1="ent0001" data-entity-2="ent0002" id="lnk3" data-source-line="4" data-link-type="dependency"><path d="M21.41,43.58 C21.41,60.52 21.41,81.18 21.41,98.2" style="stroke:#181818;stroke-width:1;" fill="none" id="a-to-b"/><polygon points="21.41,103.2,25.41,94.2,21.41,98.2,17.41,94.2,21.41,103.2" fill="#181818" style="stroke:#181818;stroke-width:1;stroke-linejoin:miter;stroke-miterlimit:10;"/></g>',
  },
  ARROW_TRIANGLE: {
    decor: 'ARROW_TRIANGLE',
    side: 'head',
    token: '>>',
    puml: '-->>',
    frag: '<!--link a to b--><g class="link" data-entity-1="ent0001" data-entity-2="ent0002" id="lnk3" data-source-line="4" data-link-type="dependency"><path d="M21.41,43.58 C21.41,60.52 21.41,78.18 21.41,95.2" style="stroke:#181818;stroke-width:1;" fill="none" id="a-to-b"/><polygon points="21.41,103.2,24.41,95.2,18.41,95.2,21.41,103.2" fill="#181818" style="stroke:#181818;stroke-width:1;stroke-linejoin:miter;stroke-miterlimit:10;"/></g>',
  },
  CIRCLE: {
    decor: 'CIRCLE',
    side: 'head',
    token: '0',
    puml: '--0',
    frag: '<!--link a to b--><g class="link" data-entity-1="ent0001" data-entity-2="ent0002" id="lnk3" data-source-line="4"><path d="M21.41,43.58 C21.41,60.52 21.41,74.18 21.41,91.2" style="stroke:#181818;stroke-width:1;" fill="none" id="a-to-b"/><ellipse cx="21.41" cy="97.2" rx="6" ry="6" fill="#FFF" style="stroke:#181818;stroke-width:1.5;"/></g>',
  },
  CIRCLE_FILL: {
    decor: 'CIRCLE_FILL',
    side: 'head',
    token: '@',
    puml: '--@',
    frag: '<!--link a to b--><g class="link" data-entity-1="ent0001" data-entity-2="ent0002" id="lnk3" data-source-line="4"><path d="M21.41,43.58 C21.41,60.52 21.41,74.18 21.41,91.2" style="stroke:#181818;stroke-width:1;" fill="none" id="a-to-b"/><ellipse cx="21.41" cy="97.2" rx="6" ry="6" fill="#181818" style="stroke:#181818;stroke-width:1.5;"/></g>',
  },
  CIRCLE_CONNECT: {
    decor: 'CIRCLE_CONNECT',
    side: 'head',
    token: '(0',
    puml: '--(0',
    frag: '<!--link a to b--><g class="link" data-entity-1="ent0001" data-entity-2="ent0002" id="lnk3" data-source-line="4"><path d="M21.41,43.58 C21.41,60.52 21.41,76.18 21.41,93.2" style="stroke:#181818;stroke-width:1;" fill="none" id="a-to-b"/><ellipse cx="21.41" cy="103.2" rx="6" ry="6" fill="#FFF" style="stroke:#181818;stroke-width:1.5;"/><path d="M28.4811,96.129 A10,10 0 0 0 14.339 96.129" fill="#FFF" style="stroke:#181818;stroke-width:1.5;"/></g>',
  },
  PARENTHESIS: {
    decor: 'PARENTHESIS',
    side: 'head',
    token: '(',
    puml: '--(',
    frag: '<!--link a to b--><g class="link" data-entity-1="ent0001" data-entity-2="ent0002" id="lnk3" data-source-line="4"><path d="M21.41,43.58 C21.41,60.52 21.41,76.18 21.41,93.2" style="stroke:#181818;stroke-width:1;" fill="none" id="a-to-b"/><path d="M29.8672,100.122 A9,9 0 0 0 12.953 100.122" fill="none" style="stroke:#181818;stroke-width:1.5;"/></g>',
  },
  SQUARE: {
    decor: 'SQUARE',
    side: 'head',
    token: '#',
    puml: '--#',
    frag: '<!--link a to b--><g class="link" data-entity-1="ent0001" data-entity-2="ent0002" id="lnk3" data-source-line="4"><path d="M21.41,43.58 C21.41,60.52 21.41,81.18 21.41,98.2" style="stroke:#181818;stroke-width:1;" fill="none" id="a-to-b"/><rect x="16.41" y="98.2" width="10" height="10" fill="#FFF" style="stroke:#181818;stroke-width:1.5;"/></g>',
  },
  PLUS: {
    decor: 'PLUS',
    side: 'head',
    token: '+',
    puml: '--+',
    frag: '<!--link a to b--><g class="link" data-entity-1="ent0001" data-entity-2="ent0002" id="lnk3" data-source-line="4" data-link-type="nested"><path d="M21.41,43.58 C21.41,60.52 21.41,70.18 21.41,87.2" style="stroke:#181818;stroke-width:1;" fill="none" id="a-to-b"/><ellipse cx="21.41" cy="95.2" rx="8" ry="8" fill="#FFF" style="stroke:#181818;stroke-width:1;"/><line x1="21.41" y1="87.2" x2="21.41" y2="103.2" style="stroke:#181818;stroke-width:1;"/><line x1="29.41" y1="95.2" x2="13.41" y2="95.2" style="stroke:#181818;stroke-width:1;"/></g>',
  },
  HALF_ARROW_UP: {
    decor: 'HALF_ARROW_UP',
    side: 'head',
    token: '\\\\',
    puml: '--\\\\',
    frag: '<!--link a to b--><g class="link" data-entity-1="ent0001" data-entity-2="ent0002" id="lnk3" data-source-line="4"><path d="M21.41,43.58 C21.41,60.52 21.41,78.18 21.41,95.2" style="stroke:#181818;stroke-width:1;" fill="none" id="a-to-b"/><line x1="21.41" y1="103.2" x2="25.41" y2="94.2" style="stroke:#181818;stroke-width:1;"/><line x1="21.41" y1="103.2" x2="21.41" y2="95.2" style="stroke:#181818;stroke-width:1;"/></g>',
  },
  HALF_ARROW_DOWN: {
    decor: 'HALF_ARROW_DOWN',
    side: 'head',
    token: '//',
    puml: '--//',
    frag: '<!--link a to b--><g class="link" data-entity-1="ent0001" data-entity-2="ent0002" id="lnk3" data-source-line="4"><path d="M21.41,43.58 C21.41,60.52 21.41,78.18 21.41,95.2" style="stroke:#181818;stroke-width:1;" fill="none" id="a-to-b"/><line x1="21.41" y1="103.2" x2="17.41" y2="94.2" style="stroke:#181818;stroke-width:1;"/><line x1="21.41" y1="103.2" x2="21.41" y2="95.2" style="stroke:#181818;stroke-width:1;"/></g>',
  },
  tail_ARROW: {
    decor: 'ARROW',
    side: 'tail',
    token: '<',
    puml: '<--',
    frag: '<!--reverse link a to b--><g class="link" data-entity-1="ent0001" data-entity-2="ent0002" id="lnk3" data-source-line="4" data-link-type="dependency"><path d="M21.41,48.58 C21.41,65.52 21.41,86.18 21.41,103.2" style="stroke:#181818;stroke-width:1;" fill="none" id="a-backto-b"/><polygon points="21.41,43.58,17.41,52.58,21.41,48.58,25.41,52.58,21.41,43.58" fill="#181818" style="stroke:#181818;stroke-width:1;stroke-linejoin:miter;stroke-miterlimit:10;"/></g>',
  },
  tail_COMPOSITION: {
    decor: 'COMPOSITION',
    side: 'tail',
    token: '*',
    puml: '*--',
    frag: '<!--reverse link a to b--><g class="link" data-entity-1="ent0001" data-entity-2="ent0002" id="lnk3" data-source-line="4" data-link-type="composition"><path d="M21.41,55.58 C21.41,72.52 21.41,86.18 21.41,103.2" style="stroke:#181818;stroke-width:1;" fill="none" id="a-backto-b"/><polygon points="21.41,43.58,17.41,49.58,21.41,55.58,25.41,49.58,21.41,43.58" fill="#181818" style="stroke:#181818;stroke-width:1;stroke-linejoin:miter;stroke-miterlimit:10;"/></g>',
  },
  tail_CROWFOOT: {
    decor: 'CROWFOOT',
    side: 'tail',
    token: '}',
    puml: '}--',
    frag: '<!--reverse link a to b--><g class="link" data-entity-1="ent0001" data-entity-2="ent0002" id="lnk3" data-source-line="4" data-link-type="crowfoot"><path d="M21.41,51.58 C21.41,68.52 21.41,86.18 21.41,103.2" style="stroke:#181818;stroke-width:1;" fill="none" id="a-backto-b"/><line x1="21.41" y1="51.58" x2="13.41" y2="43.58" style="stroke:#181818;stroke-width:1;"/><line x1="21.41" y1="51.58" x2="29.41" y2="43.58" style="stroke:#181818;stroke-width:1;"/><line x1="21.41" y1="51.58" x2="21.41" y2="43.58" style="stroke:#181818;stroke-width:1;"/></g>',
  },
  tail_EXTENDS: {
    decor: 'EXTENDS',
    side: 'tail',
    token: '<|',
    puml: '<|--',
    frag: '<!--reverse link a to b--><g class="link" data-entity-1="ent0001" data-entity-2="ent0002" id="lnk3" data-source-line="4" data-link-type="extension"><path d="M22,61.58 C22,78.52 22,86.18 22,103.2" style="stroke:#181818;stroke-width:1;" fill="none" id="a-backto-b"/><polygon points="22,43.58,16,61.58,28,61.58,22,43.58" fill="none" style="stroke:#181818;stroke-width:1;stroke-linejoin:miter;stroke-miterlimit:10;"/></g>',
  },
};
...
describe('SvekEdgeInput.styleThickness (bracket thickness=N override)', () => {
  test('draws the path AND the filled extremity at the overridden thickness', () => {
    ...
    expect(frag).toContain(
      '<path d="M21.41,43.58 C21.41,60.52 21.41,81.18 21.41,98.2" style="stroke:#181818;stroke-width:8;" fill="none" id="a-to-b"/>',
    );
...
describe('SvekEdgeInput.color (bracket #color override reaches both path and extremity)', () => {
  test('a non-default color feeds both the path stroke and the filled arrowhead fill+stroke', () => {
    ...
    expect(frag).toContain(
      'fill="#00F" style="stroke:#00F;stroke-width:1;stroke-linejoin:miter;stroke-miterlimit:10;"',
    );
  });
});
