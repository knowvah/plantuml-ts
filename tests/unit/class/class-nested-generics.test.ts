...
describe('nested-generic classifier declarations', () => {
  ...
  it(
    "zaxate-23-xifa551: a quoted-alias display's own generic is extracted, " + 'the header shows the BARE name',
    () => {
  ...
  it('a bare quoted name (no alias) keeps its full display/id -- ' + 'no generic extraction', () => {
