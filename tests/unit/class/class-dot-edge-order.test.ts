...
describe('class-dot-edge-order.ts getOrderedLinks', () => {
  it(
    'replays bicabi-42-coto932: lnk12 (AddObjectWindow,DrawOptionsBox) lands ' +
  ...
  it(
    'groups a three-way same-connection cluster contiguously, each new ' +
...
describe('class-dot-edge-order.ts getOrderedLinks — wired into class-dot-graph.ts', () => {
  ...
  it(
    'emits DOT edge "draw_options_box" immediately after "add_object_window" ' +
