...
describe('computeInkShift — mechanism C ink-extent margin', () => {
  ...
  it(
    'anchors a single actor leaf at box (5.5,5.5): ActorStickMan draws its head ' +
  ...
  it(
    'picks the GLOBAL per-axis minimum across independent entities, not one ' +
  ...
  it(
    'shifts a non-zero raw position by the same delta (translation-additive: the ' +
