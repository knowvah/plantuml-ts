...
parallel implementation. dot-engine findings go in
...
| pevene minlen=0 clip-inset delta | 1 | Sub-0.5px dot-engine delta, needs a 2nd sample |
...
3. **Mechanism 16 (entity-vs-cluster wrap)** — a DOT-native cluster-label
   sizing path (library-level, `graph-layout.ts`/dot-engine cluster
