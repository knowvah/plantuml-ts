...
|---|---|---|---|---|---|
| T0a | Commit the activity oracle probe | typescript-pro | `scripts/activity-probe.ts`, its unit test | — | [ ] |
| T0b | Commit the activity baseline re-pin tool | typescript-pro | `scripts/repin-activity-baselines.ts`, its unit test | — | [ ] |
