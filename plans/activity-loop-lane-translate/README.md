...
| [1](batch-1/overview.md) | T2 while back · T3 repeat out/simple1/simple2/complex1 | T1b then T2 ∥ T3 (worktrees) | resumed 2026-09-20 with T1b (stops 1 + 14, see [`stop-1-edgemeta-zip.md`](stop-1-edgemeta-zip.md)) [ ] |
