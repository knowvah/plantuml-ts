...
|---|---|---|---|---|---|
| T0 | Classify the 22 rows by connection class; read `UGraphicInterceptorOneSwimlane` for D5; confirm or strike D9 | debugger | `fixtures.md`, `measurements/`, `decision-journal.md`, `.agent-notes/allt-T0.md`, `planning/next-missions.md` (re-filings only) | — | [ ] |
