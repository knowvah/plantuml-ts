...
| T1b | Thread `PlacementResult.edgeMeta` and `midArrowAt` through `assign-coordinates-full`, `compress-geometry`, `shapes-of` (human grant 2026-09-20 after stops 1/14) | typescript-pro | see spec | T1 | [ ] |
