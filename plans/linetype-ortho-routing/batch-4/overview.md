...
|---|---|---|---|---|---|
| T8 | Re-measure all 8, re-pin, name every mover | orchestrator | `oracle/goldens/svg-conformance/splines-baseline.json`, `tests/oracle/svg-conformance/parity-{class,state}.json`, `parity.json`, `oracle/goldens/state/size-backlog.json`, `tests/visual/data/*.json` (only if moved), `.agent-notes/lor-T8.md` | T7 | [x] |
