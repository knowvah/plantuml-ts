...
| T2 | Delete `atomsWidth` + `tryRenderUSymbol` atom-label fallback closure | typescript-pro | `src/diagrams/class/renderer.ts`, `src/diagrams/class/class-geo-types.ts`, affected class tests | — | [ ] |
