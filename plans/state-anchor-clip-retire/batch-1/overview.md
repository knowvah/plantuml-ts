...
|---|---|---|---|---|---|
| T1 | Prove node geos are final and same-frame at every pass site; verify D4 and D5 | general-purpose (opus) | `.agent-notes/si32-T1.md`, `plans/state-anchor-clip-retire/decision-journal.md` | T0 | [ ] |
