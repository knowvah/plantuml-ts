...
| T15 | bookkeeping: `planning/next-missions.md`, `planning/mission-index.md` Snapshot, `.agent-notes/unknown-bucket-mapping.md` outcome section | documentation-engineer (sonnet; has Edit) | those three files | T14 | [x] |
