...
|---|---|---|---|---|---|---|
| T2 | activity-jar: `activity-legacy1-example-*` 25 + ACTIVITY→description/class/state/refusals 13 | 38 | typescript-pro | `unknown-ledger/T2-activity-jar.json`, `diagnosis/T2.md` | T0, T1 | [ ] |
| T3 | class-jar refusals: `Class-visibility-*` 16 + 3 | 19 | typescript-pro | `unknown-ledger/T3-class-refusals.json`, `diagnosis/T3.md` | T0, T1 | [ ] |
| T4 | class-jar misroutes: CLASS→DESCRIPTION 42, →SEQUENCE 3, →STATE 1 | 46 | typescript-pro | `unknown-ledger/T4-class-misroutes.json`, `diagnosis/T4.md` | T0, T1 | [ ] |
| T5 | description-, sequence- and state-jar: 12 + 5 + 1 | 18 | typescript-pro | `unknown-ledger/T5-descr-seq.json`, `diagnosis/T5.md` | T0, T1 | [ ] |
| T6 | jar NONE: we error 35, NONE→STATE 1 | 36 | typescript-pro | `unknown-ledger/T6-jar-none.json`, `diagnosis/T6.md` | T0, T1 | [ ] |
