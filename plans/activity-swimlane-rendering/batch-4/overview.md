...
|---|---|---|---|---|---|
| T4 | Per-lane content extents and content-fitted widths | typescript-pro | `src/diagrams/activity/layout/swimlane-context.ts`, `src/diagrams/activity/activity-layout-types.ts` | T3 | [x] |
