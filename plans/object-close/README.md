...
| [batch-2](batch-2/overview.md) | Governed fix loop (B0…Bn) | loop — B0–B6, B10 landed; object census 23 → **31/80**, ratchet 22 → 30 | [ ] |
...
| object SVG census | non-dropping — **31/80** after B10 (was 23 at T1) | `npx tsx scripts/svg-conformance-census.ts object` |
