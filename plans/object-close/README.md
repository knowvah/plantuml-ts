...
| [batch-2](batch-2/overview.md) | Governed fix loop (B0…Bn) | loop — B0–B7, B10, B20, B21, B25, B31 landed; object census 23 → **32/80**, ratchet 22 → 31 | [ ] |
...
| object SVG census | non-dropping — **32/80** after B21 (was 23 at T1) | `npx tsx scripts/svg-conformance-census.ts object` |
