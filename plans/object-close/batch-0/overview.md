...
| [T1](T1-recapture-oracle.md) | Re-capture `test-results/dot-cache/object/` through the pinned jar; regenerate `parity-object.json`; record the true baseline | general-purpose | `test-results/dot-cache/object/**`, `tests/oracle/svg-conformance/parity-object.json`, `plans/object-close/decision-journal.md` | T0 | [ ] |
