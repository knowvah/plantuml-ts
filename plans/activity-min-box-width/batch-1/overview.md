...
|---|---|---|---|---|---|
| T1 | `activityMinimumWidth`, `activityFontColor`, `activityHorizontalAlignment` | typescript-pro | `src/diagrams/activity/activity-style-defaults.ts`, `tests/unit/activity/activity-style-defaults.test.ts` | — | [ ] |
