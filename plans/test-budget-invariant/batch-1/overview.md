...
|---|---|---|---|---|---|
| T1 | Fix the `:429` omission; extract 42 `120_000` literals to one named constant | typescript-pro (sonnet) | `tests/helpers/*` (new constant), the 10 test files carrying `120_000`, `.agent-notes/tbi-T1.md` | — | [ ] |
| T2 | Diagnose `catalog.test.ts`'s load sensitivity to a stated mechanism | typescript-pro (sonnet) | `.agent-notes/tbi-T2.md` only | — | [ ] |
