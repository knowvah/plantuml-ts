...
|---|---|---|---|---|---|
| T17 | Canvas ink term at its origin (9): R-1, R-2, R-3 + diagnose R-5/6/7/9 | debugger (fix mode) | `class-ink-box.ts`, `class-ink-shapes.ts`, `class-layout-generic-classifier.ts`, `class-geo-types.ts`, `class-object-sizing.ts`, `layout-ink-extent.ts` + tests | T16 | [ ] |
