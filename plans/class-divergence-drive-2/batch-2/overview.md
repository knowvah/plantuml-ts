...
| T12 | Q-2 Kal endpoint + ctrl shift, Q-7 Kal overlap (5 + Q-2 everywhere) | typescript-pro | `class-edge-geo.ts` (attachKalBoxes), `renderer-arrowhead.ts`, `class-kal.ts` (+ `class-kal-overlap.ts`) + tests | T10 | [ ] |
