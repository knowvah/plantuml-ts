...
|----|-------------|-------|--------|-----------|------|
| T3 | Emoji/wide-glyph width: fixed fallback OR document | debugger | `measurer*` (+ test) OR `plans/s1l-leaf-sizing/ledger.md` | T1 | ☐ |
| T4 | Re-baseline backlog + ledger + mission-index; full gate | typescript-pro | `size-backlog.json`, `ledger.md`, `planning/mission-index.md` | T1, T2, T3 | ☐ |
