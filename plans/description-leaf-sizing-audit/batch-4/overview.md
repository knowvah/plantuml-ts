...
| T9 | **RESCOPED** — delete ONLY what T6 superseded + the dead `inkSprites` field | refactoring-specialist | `src/diagrams/description/leaf-sizing-consts.ts`, `layout.ts`, `layout-dot-tree.ts` | T6, T7, T8 | [x] |
