...
|---|---|---|---|---|---|
| T1 | Shared mode: reader registry, writer intent/drain, stale reclaim, ownership-safe reader release (TDD) | typescript-pro (sonnet) | `scripts/build-stdlib-packages/build-lock.ts`, `tests/unit/build-stdlib-lock.test.ts` | T0 | [ ] |
