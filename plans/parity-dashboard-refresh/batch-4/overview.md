...
| T8 | bookkeeping: planning docs, README support table → pointer, svg-conformance status section | technical-writer (sonnet) | `planning/next-missions.md`, `planning/mission-index.md`, `README.md`, `docs/svg-conformance.md` | T7 | [x] |
