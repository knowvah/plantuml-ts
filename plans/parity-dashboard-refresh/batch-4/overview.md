...
|---|---|---|---|---|---|
| T7 | run every producer over every cached type; regenerate both dashboards | orchestrator | `tests/oracle/svg-conformance/parity*.json`, `tests/oracle/svg-conformance/census-*.json`, `tests/oracle/svg-conformance/PARITY-SVG.md`, `docs/parity-report.md` | T5, T6 | [ ] |
