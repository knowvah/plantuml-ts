...
|---|---|---|---|
| [1](batch-1/overview.md) | T1 capture script · T2 census `--json` + activity · T3 survey/dashboard all types · T4 DOT rows n/a + export | 4 parallel agents (separate worktrees) | [ ] |
