...
|---|---|---|---|---|---|
| T2 | The activity style-default table and its resolvers | typescript-pro | `src/diagrams/activity/activity-style-defaults.ts`, `tests/unit/activity/activity-style-defaults.test.ts` | T1 | [x] |
