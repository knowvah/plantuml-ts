...
```plantuml
@startuml
participant "acyclic" as AC
participant "assignRanks" as RK
participant "TB_balance" as TB
participant "minimizeCrossings" as MC
participant "assignCoordinates" as PO
participant "routeEdges" as SP
