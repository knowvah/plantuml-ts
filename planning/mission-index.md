...
| S1L-g | description minClassWidth/MinimumWidth floor | todo | S1L | 4 fixtures (dexigu-24, kenece-24, zifaji-87, zotiru-33 — up to 2.37in each): wire the `minClassWidth`/`MinimumWidth` skinparam to the leaf-box width floor. Cleanest bounded port. Exit: those backlog entries → ≤0.01in, deleted |
