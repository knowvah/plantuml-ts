...
| S1L-a | description package/folder tab geometry (leaf) | todo | S1L | 3 fixtures (codabo-50, tajadu-40, cobuju-30, 0.17–0.99in): form-dependent leaf tab geometry (`package "X"` no braces). Exit: those backlog entries → ≤0.01in, deleted |
