...
| S1L-c | description interface shield sizing | todo | S1L | 11 fixtures: size a shielded `interface` as the fixed 0.25in circle (gate `isInterfaceShielded` exists; wire the sizing). Exit: those backlog entries → ≤0.01in, deleted |
