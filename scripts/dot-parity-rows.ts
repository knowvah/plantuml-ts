 ...
 *
 * Twenty-two diagram types never emit PlantUML's svek-N.dot dump, so a DOT-parity
 ...
 * tree (`PSystemBuilder.java:184` is commented out). The ten buckets this port
 * has no engine for are the same shape: gantt, mindmap, wbs, salt, ebnf,
 * regex, wire, timing and nwdiag all `extends TitledDiagram`
 * (`gantt/GanttDiagram.java`, `mindmap/MindMapDiagram.java`, `wbs/WBSDiagram.java`,
 * `salt/PSystemSalt.java`, `ebnf/PSystemEbnf.java`, `regexdiagram/PSystemRegex.java`,
 * `wire/WireDiagram.java`, `timingdiagram/TimingDiagram.java`, `nwdiag/NwDiagram.java`)
 * and ditaa is a `DirectOsDiagram` (`ditaa/PSystemDitaa.java`, PNG through the
 * ditaa library). c4 is NOT here: it is a description diagram. Reporting "not yet measured"
