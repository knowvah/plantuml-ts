...
/** Static document header. The "diverged by construction" note is load-bearing:
 *  without it a reader takes a 99%-diverged table as a rendering emergency,
 *  when it is the D12 measurer gap the ratchet exists to see past. */
