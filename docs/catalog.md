...
1174 modules · 4352 exported names.
...
| `class-scale-geo.ts` | `ScaleSpec`, `scaleClassGeometry` | class-scale-geo.ts — the `scale ...` directive for the class engine, applied at the layout->render boundary (cdd-T29, D4 -- `plans/class-divergence-drive/decisions.md`). |
